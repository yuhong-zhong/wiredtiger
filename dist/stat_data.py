...
connection_stats = [
    ...
    TxnStat('txn_checkpoint_buckets_walked_conn_dhandle_find', 'transaction checkpoint buckets walked trying to find dhandle in the conn list', 'no_clear,no_scale'),
    TxnStat('txn_checkpoint_buckets_walked_session_find_dhandle', 'transaction checkpoint buckets walked trying to find dhandle in the session cache', 'no_clear,no_scale'),
    TxnStat('txn_checkpoint_lock_to_delete_duration', 'transaction checkpoint time taken to lock the checkpoints to be deleted during prepare (usecs)', 'no_clear,no_scale'),
    TxnStat('txn_checkpoint_get_ckptlist_duration', 'transaction checkpoint time taken to obtain checkpoint list from metadata (usecs)', 'no_clear,no_scale'),
    TxnStat('txn_checkpoint_handle_metadata_race_check_duration', 'transaction checkpoint time taken to check for racing metadata operation (usecs)', 'no_clear,no_scale'),
    TxnStat('txn_checkpoint_handle_re_obtain_for_apply_list_insert_duration', 'transaction checkpoint time taken to re-obtain dhandle for inserting into the apply list (usecs)', 'no_clear,no_scale'),
    TxnStat('txn_checkpoint_handle_session_cache_duration', 'transaction checkpoint time taken to bring dhandles to the session cache (usecs)', 'no_clear,no_scale'),
